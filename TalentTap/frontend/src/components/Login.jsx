...
const Login = () => {
	...
	return (
		<section className="bg-indigo-500/90">
					...
					<div className="p-6 space-y-4 md:space-y-6 sm:p-8">
						...
						>
							...
							<div className="flex items-center justify-between">
								...
								<a
									href="#"
									className="text-sm font-medium text-primary-600 hover:text-green-200 dark:text-white"
								>
									Forgot password?
								</a>
							</div>
							...
							<p className="text-sm font-light text-gray-500 dark:text-gray-400">
								Don't have an account yet? <Link to={'/'}><span className='text-sm font-light'>Sign up</span></Link>
							</p>
						</form>
					</div>
				</div>
